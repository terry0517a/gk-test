        ...
        <div className="max-w-xl mx-auto mb-8">
          ...
          <div className="space-y-3">
            {figures.map((figure) => (
              <div
                key={figure.id}
                className="w-full bg-gray-800 border border-gray-700 rounded-xl p-3 text-left hover:border-gray-600 transition-colors"
              >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        <span className="px-1.5 py-0.5 text-xs rounded bg-amber-900/50 text-amber-300 font-medium flex-shrink-0">GK</span>
